...
public class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // Extract the array associated with the key "results", which represents the list of
            // news.
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Extract the features that we want for the news
                ...
                try {
                    publicationDate = (new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss")).parse(dateTime);
                } catch (Exception e) {
                ...
                // Create a new {@link News} object with the title, section, publicationDate and url
                // from the JSON response.
                News news = new News(title, section, author, publicationDate, url);

                // Add the {@link News} to the list of news.
                listNews.add(news);
            }
